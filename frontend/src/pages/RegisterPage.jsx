        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full bg-white/5 text-white border border-white/10 rounded-xl pl-4 pr-12 py-3 text-sm outline-none focus:border-red-500/60 focus:bg-white/[0.07] transition-all placeholder:text-white/20"
            />
            <button
              type="button"
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-white/40 hover:text-white/70 focus:text-white/70 focus:outline-none transition-colors"
            >
