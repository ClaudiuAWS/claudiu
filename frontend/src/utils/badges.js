...
export const BADGE_CATALOG = [
  ...
  },
  {
    ...
    image: '/badge-golden-boot.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
    ...
    image: '/badge-goal-machine.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
  ...
  },
  {
    ...
    image: '/badge-comeback-goal.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
    ...
    image: '/badge-late-winner.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
    ...
    image: '/badge-penalty-king.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
    ...
    image: '/badge-defender-goal.png?v=3',
    tier: 'bronze',
    discReward: null,
  },
  ...
  // ---- Defensive badges ---------------------------------------------------
  {
    ...
    image: '/badge-clean-sheet.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
    ...
    image: '/badge-clean-sheet-streak.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
    ...
    image: '/badge-keeper-hero.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  ...
  },
  {
    ...
    image: '/badge-comeback-win.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
    ...
    image: '/badge-win-streak-3.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
    ...
    image: '/badge-win-streak-5.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
    ...
    image: '/badge-dominant-win.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  ...
  // concept and no opponent-rating system, so these would never trigger.
  {
    ...
    image: '/badge-perfect-match.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  ...
  // ---- Mini-game badges ---------------------------------------------------
  {
    ...
    image: '/badge-quiz-master.png?v=3',
    tier: 'silver',
  ...
  },
  {
    ...
    image: '/badge-quiz-perfect-5.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
    ...
    image: '/badge-reflex-master.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  ...
  // ---- Progression badges -------------------------------------------------
  {
    ...
    image: '/badge-first-match.png?v=3',
    tier: 'bronze',
    discReward: null,
  },
  {
    ...
    image: '/badge-team-builder.png?v=3',
    tier: 'bronze',
    discReward: null,
  },
  {
    ...
    image: '/badge-weekend-warrior.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
    ...
    image: '/badge-veteran-10.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
    ...
    image: '/badge-veteran-50.png?v=3',
    tier: 'gold',
    discReward: null,
  },
  {
  ...
  // ---- Social badges ------------------------------------------------------
  {
    ...
    image: '/badge-social-butterfly.png?v=3',
    tier: 'bronze',
    discReward: null,
  },
  ...
  },
  {
    ...
    image: '/badge-goalkeeper-1.png?v=3',
    tier: 'bronze',
    discReward: null,
  },
  {
    ...
    image: '/badge-goalkeeper-5.png?v=3',
    tier: 'silver',
    discReward: null,
  },
  {
...
export const TIER_ORDER = { bronze: 0, silver: 1, gold: 2 }

// Reverse map: shop disc item ID → badge ID that also unlocks the disc.
// Lets the shop show "Already unlocked via badge" instead of a buy CTA
// when the user has earned the badge that grants the same track.
// Keep in lockstep with `discReward` fields above.
const SHOP_DISC_TO_BADGE = {
  'disc-waka-waka':  'first_win',
  'disc-we-are-one': 'hattrick',
  'disc-walk':       'quiz_master',
}

/** Returns the badgeId that unlocks the same disc as the given shop itemId,
 *  or null if the item isn't a disc that has a matching badge. */
export function getBadgeForShopItem(itemId) {
  return SHOP_DISC_TO_BADGE[itemId] || null
}
